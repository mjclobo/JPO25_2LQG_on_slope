...
##
wf_m1p0_hm0p25 = calc_wf(zonal_ind, 6, 4, data_dir_psi_ot, model_params);  # zonal slice index, h_ind, mu_ind

nt = size(wf_m1p0_hm0p25)[2]
...
wf_out_m1p0_hm0p25 = Dict("w_f_spectrum" => wf_m1p0_hm0p25, "dt" => dt, "fr"=> fr)

jldsave("./wf_m1p0_hm0p25_total_EKE.jld"; wf_out_m1p0_hm0p25)
