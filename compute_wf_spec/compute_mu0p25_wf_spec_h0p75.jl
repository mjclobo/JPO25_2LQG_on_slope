...
wf_m0p25_h0p75, rat_m0p25_h0p75 = calc_wf(zonal_ind, 10, 2, data_dir_psi_ot, model_params);  # zonal slice index, h_ind, mu_ind

nt = size(wf_m0p25_h0p75)[2]
...
wf_out_m0p25_h0p75 = Dict("w_f_spectrum" => wf_m0p25_h0p75, "w_f_ratio" => rat_m0p25_h0p75, "dt" => dt, "fr"=> fr)

jldsave("./wf_m0p25_h0p75_total_EKE.jld"; wf_out_m0p25_h0p75)
