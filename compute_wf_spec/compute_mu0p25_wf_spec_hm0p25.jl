...
wf_m0p25_hm0p25, rat_m0p25_hm0p25 = calc_wf(zonal_ind, 6, 2, data_dir_psi_ot, model_params);  # zonal slice index, h_ind, mu_ind

nt = size(wf_m0p25_hm0p25)[2]
...
wf_out_m0p25_hm0p25 = Dict("w_f_spectrum" => wf_m0p25_hm0p25, "w_f_ratio" => rat_m0p25_hm0p25, "dt" => dt, "fr"=> fr)

jldsave("./wf_m0p25_hm0p25_total_EKE.jld"; wf_out_m0p25_hm0p25)
